                  ...
                  <div className="w-full md:w-1/2 border-t md:border-t-0 md:border-l border-slate-800 bg-obsidian-950 p-6 overflow-y-auto flex flex-col text-left">
                    ...
                    <div className="space-y-4 flex-1">
                      ...
                      <div className="grid grid-cols-2 gap-2.5">
                        {selectedLead.phone ? (
                          <a
                            href={`https://wa.me/${selectedLead.phone.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(`Hi ${selectedLead.name}, this is TechyDeveloper Executive Team regarding your inquiry.`)}`}
                            target="_blank"
                        ...
                        {selectedLead.email ? (
                          <a
                            href={`mailto:${selectedLead.email}?subject=${encodeURIComponent(`TechyDeveloper - Proposal for ${selectedLead.company || selectedLead.name}`)}`}
                    ...
                    {registeredUsers.map((u) => (
                      <div key={u.id} className="p-4 rounded-2xl bg-obsidian-900 border border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <a
                            href={`https://wa.me/?text=${encodeURIComponent(`Hi ${u.name}, this is TechyDeveloper Executive Team.`)}`}
                            target="_blank"
                            rel="noopener noreferrer"
